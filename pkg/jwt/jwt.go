...
// NewManager creates a new JWT manager with the given secret
...
// ParseUserID extracts the user ID from a token string without full validation
// (useful for logging; prefer ValidateToken for auth decisions)
